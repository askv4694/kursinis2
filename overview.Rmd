...
#kurie panasiausi
names <- colnames(cg_trait[,c(1:3, 5:7, 192:200, 300)] )
#length(names)
...
trait_dist <- getDistance(cg_trait, names[2], names)
data.frame(trait_dist)
...
```{r}
stud_dist <- getDistance(cg_study, colnames(cg_study)[4], colnames(cg_study) )
data.frame(stud_dist)
#distance
